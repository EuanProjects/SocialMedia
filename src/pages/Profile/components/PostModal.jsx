...
function PostModal({ handleDisplayPostModal }) {
    ...
    return (
        <div className="grid w-screen h-screen absolute place-items-center">
            ...
            <Form onSubmit={handleCloseModal}
                method="POST" className="w-1/2 bg-metallicGray rounded-lg p-4 absolute grid grid-rows-[64px_min(124px)_64px]">
                ...
                <div>
                    ...
                    <div><button className="w-full rounded-lg bg-rocketRed h-8" type="submit">Post</button></div>
                </div>
            </Form>
        </div>
    )
